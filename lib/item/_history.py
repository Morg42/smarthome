...
class ItemHistory:
    ...
    __slots__ = (
        '_last_change', '_prev_change', '_changed_by', '_prev_change_by',
        '_last_update', '_prev_update', '_updated_by', '_prev_update_by',
        '_last_trigger', '_prev_trigger', '_triggered_by', '_prev_trigger_by',
        '_last_value', '_prev_value',
    )
    ...
    def record_change(self, old_value, caller, source, shtime,
                      prev_change=None, last_change=None):
        """
    ...
    def get_last_change(self):   return self._last_change
    def get_last_change_by(self): return self._changed_by
    def get_last_update(self):   return self._last_update
    def get_last_update_by(self): return self._updated_by
    def get_last_trigger(self):  return self._last_trigger
    def get_last_trigger_by(self): return self._triggered_by
    def get_last_value(self):    return self._last_value
    def get_prev_change(self):   return self._prev_change
    def get_prev_change_by(self): return self._prev_change_by
    def get_prev_update(self):   return self._prev_update
    def get_prev_update_by(self): return self._prev_update_by
    def get_prev_trigger(self):  return self._prev_trigger
    def get_prev_trigger_by(self): return self._prev_trigger_by
    def get_prev_value(self):    return self._prev_value
