...
class TestMergeSubstructToStruct(_StructsTestBase):
    def setUp(self):
        ...
        Structs._struct_definitions['base.common'] = _od(
            ('name', 'default_name'), ('unit', 'celsius'), ('__struct_is_optional', False)
        )
    ...
    def test_list_values_merged(self):
        Structs._struct_definitions['base.listprovider'] = _od(('tags', ['a', 'b']), ('__struct_is_optional', False))
        main = _od(('tags', ['c']))
...
class TestResolveStructs(_StructsTestBase):
    def setUp(self):
        ...
        Structs._struct_definitions['plug.base'] = _od(
            ('unit', 'V'), ('precision', '2'), ('__struct_is_optional', False)
        )
...
class TestTraverseStruct(_StructsTestBase):
    ...
    def test_traverse_struct_without_struct_attr_returns_false(self):
        Structs._struct_definitions['plug.simple'] = _od(('type', 'num'), ('name', 'sensor'))
        result = self.s.traverse_struct('plug.simple')
        self.assertFalse(result)

    def test_traverse_struct_with_struct_attr_returns_true(self):
        Structs._struct_definitions['plug.base'] = _od(('unit', 'V'), ('__struct_is_optional', False))
        Structs._struct_definitions['plug.composite'] = _od(('type', 'num'), ('struct', 'plug.base'))
    ...
    def test_process_struct_node_nested_dict_processed(self):
        Structs._struct_definitions['p.sub'] = _od(('extra', 'val'), ('__struct_is_optional', False))
        node = _od(('child', _od(('struct', 'p.sub'), ('own_key', 'own_val'))))
