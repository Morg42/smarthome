...
Dieses Release ist ein Feature-Release. Es gibt einige neuer Features im Core
...
v1.12.0 sind im Folgenden in diesen Release Notes beschrieben.
...
Offiziell unterstützt werden im SmartHomeNG Release 1.12.1 die Python-Versionen 3.10, 3.11, 3.12 und 3.13.
...
* uzsu:
  ...
  * minor code improvement based on https://github.com/smarthomeng/plugins/pull/1042
  * fix issue with activetoday
  * fix sunrise/set calculation
